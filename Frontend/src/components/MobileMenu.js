      ...
      <div className='offcanvas-container' id='mobile-menu'>
        <a className='account-link' href='account-orders.html'>
          <div className='user-ava'>
            <img
              src={require('../assets/img/account/user-ava-md.jpg')}
              alt='Daniel Adams'
            />
          </div>
          ...
          <ul className='menu'>
            <li className='has-children'>
              ...
              <ul className='offcanvas-submenu'>
                ...
                <li>
                  <a href='home-featured-categories.html'>
                    Featured Categories
                  </a>
                </li>
                <li>
                  <a href='home-collection-showcase.html'>
                    Products Collection Showcase
                  </a>
                </li>
                <li>
                  <a href='home-dark-header.html'>Dark Header</a>
                </li>
              </ul>
            </li>
            <li className='has-children'>
            ...
            <li className='has-children'>
              ...
              <ul className='offcanvas-submenu'>
                ...
                <li>
                  <a href='account-password-recovery.html'>Password Recovery</a>
                </li>
                <li>
                ...
                <li>
                  <a href='account-profile.html'>Profile Page</a>
                </li>
                <li>
                  <a href='account-address.html'>Contact / Shipping Address</a>
                </li>
                <li>
                  <a href='account-open-ticket.html'>Open Ticket</a>
                </li>
                <li>
              ...
              <ul className='offcanvas-submenu'>
                ...
                <li className='has-children'>
                  ...
                  <ul className='offcanvas-submenu'>
                    ...
                    <li>
                      <a href='blog-rs.html'>Blog Right Sidebar</a>
                    </li>
                    <li>
                      <a href='blog-ls.html'>Blog Left Sidebar</a>
                    </li>
                    <li>
                      <a href='blog-ns.html'>Blog No Sidebar</a>
                    </li>
                  </ul>
                </li>
                <li className='has-children'>
                  <span>
                    <a href='blog-single-rs.html'>
                      <span>Single Post Layout</span>
                    </a>
                    <span className='sub-menu-toggle'></span>
                  </span>
                  <ul className='offcanvas-submenu'>
                    ...
                    <li>
                      <a href='blog-single-rs.html'>Post Right Sidebar</a>
                    </li>
                    <li>
                      <a href='blog-single-ls.html'>Post Left Sidebar</a>
                    </li>
                    <li>
                      <a href='blog-single-ns.html'>Post No Sidebar</a>
                    </li>
                  </ul>
                </li>
              </ul>
            ...
            <li className='has-children active'>
              ...
              <ul className='offcanvas-submenu'>
                ...
                <li>
                  <a href='mobile-app.html'>Unishop Mobile App</a>
                </li>
                <li>
            ...
            <li className='has-children'>
              ...
              <ul className='offcanvas-submenu'>
                ...
                <li>
                  <a href='components/images.html'>Images &amp; Figures</a>
                </li>
                <li>
                ...
                <li>
                  <a href='components/toasts.html'>Toast Notifications</a>
                </li>
                <li>
                ...
                <li>
                  <a href='components/video-player.html'>Video Player</a>
                </li>
                <li>
